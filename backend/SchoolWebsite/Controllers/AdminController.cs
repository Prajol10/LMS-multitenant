...
namespace SchoolWebsite.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateOwnSchool(UpdateTenantDto dto)
        {
            ...
            tenant.LogoUrl = dto.LogoUrl != null ? dto.LogoUrl : tenant.LogoUrl;
            tenant.BannerUrl = dto.BannerUrl != null ? dto.BannerUrl : tenant.BannerUrl;
            tenant.PrimaryColor = dto.PrimaryColor ?? tenant.PrimaryColor;
            tenant.AccentColor = dto.AccentColor ?? tenant.AccentColor;
            tenant.AboutText = dto.AboutText != null ? dto.AboutText : tenant.AboutText;
            tenant.Address = dto.Address != null ? dto.Address : tenant.Address;
            tenant.Phone = dto.Phone != null ? dto.Phone : tenant.Phone;
            tenant.Email = dto.Email != null ? dto.Email : tenant.Email;
            tenant.EstablishedYear = dto.EstablishedYear ?? tenant.EstablishedYear;
            tenant.FacebookUrl = dto.FacebookUrl != null ? dto.FacebookUrl : tenant.FacebookUrl;
            tenant.InstagramUrl = dto.InstagramUrl != null ? dto.InstagramUrl : tenant.InstagramUrl;
            tenant.WebsiteUrl = dto.WebsiteUrl != null ? dto.WebsiteUrl : tenant.WebsiteUrl;
            tenant.MapEmbedUrl = dto.MapEmbedUrl != null ? dto.MapEmbedUrl : tenant.MapEmbedUrl;
            tenant.VideoUrl = dto.VideoUrl != null ? dto.VideoUrl : tenant.VideoUrl;
            tenant.AboutImageUrl = dto.AboutImageUrl != null ? dto.AboutImageUrl : tenant.AboutImageUrl;
        ...
        private static TenantDto MapToDto(Tenant t) => new()
        {
            ...
            TotalStudents = t.TotalStudents, TotalTeachers = t.TotalTeachers,
            TotalPrograms = t.TotalPrograms, TotalStaff = t.TotalStaff,
