      ...
      {tenant.videoUrl && (
        <section id="video" className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl max-w-4xl mx-auto" style={{ paddingTop: '56.25%' }}>
              <iframe src={tenant.videoUrl.replace('watch?v=', 'embed/')} title="School Video"
